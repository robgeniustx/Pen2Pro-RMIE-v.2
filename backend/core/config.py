...
# One-time founder prices (Stripe Price IDs)
...
STRIPE_CONNECT_RETURN_URL = env_optional("STRIPE_CONNECT_RETURN_URL", f"{FRONTEND_URL}/partners/return")
STRIPE_CONNECT_REFRESH_URL = env_optional("STRIPE_CONNECT_REFRESH_URL", f"{FRONTEND_URL}/partners/refresh")
